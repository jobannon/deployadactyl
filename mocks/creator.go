...
func (c Creator) PushManager(deployEventData S.DeployEventData, cf I.CFContext, auth I.Authorization, env S.Environment, envVars map[string]string) I.ActionCreator {
